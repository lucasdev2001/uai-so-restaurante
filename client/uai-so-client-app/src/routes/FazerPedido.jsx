...
function FazerPedido() {
    ...
    switch (id) {
      case "avançar":
        ...
        if (refEtapa.current.etapa < nomesEtapas.length - 1) {
          let inputsDivAtual = document.getElementById(
            `${refEtapa.current.etapa}`
          );
          if (1 === 0) {
            ...
            barraProgresso.style.width = `${
              (100 / nomesEtapas.length + 3) * refEtapa.current.etapa
            }%`;
  ...
  const limitadorComplemento = (event) => {
    let inputCarnes = document.querySelectorAll(
      'input[name="complemento"]:checked'
    );
    if (inputCarnes.length >= 3) {
      event.target.checked = false;
    } // limita o número de checkbox selecionadas
  ...
  const montarMarmita = () => {
    ...
    let arrComplementos = [];
    let inputCarnes = document.querySelectorAll('input[name="carne"]:checked');
    let inputComplementos = document.querySelectorAll(
      'input[name="complemento"]:checked'
    );
      ...
      <main>
        <div className="container-fluid">
          <form method="POST" id="form-marmita">
            <h2 className="text-center display-1" id="nome-etapa">
              Escolha seu arroz
            </h2>
            ...
            <div>
                ...
                <div className="d-flex justify-content-center mt-5">
                  <div className="form-check mb-3">
                    ...
                    <input
                      ...
                      required
                    ></input>
                    <label className="form-check-label fs-1">Sem arroz</label>
                  </div>
                </div>
              </div>
                ...
                <div className="d-flex justify-content-center mt-5">
                  <div className="form-check mb-3">
                    ...
                    <input
                      ...
                      required
                    ></input>
                    <label className="form-check-label fs-1">Sem feijão</label>
                  </div>
                </div>
              </div>
                ...
                <div className="d-flex justify-content-center mt-5">
                  <div className="form-check mb-3">
                    <input
                      ...
                      required
                    ></input>
                    <label className="form-check-label fs-1">Sim</label>
                    <br />
                    <input
                      className="form-check-input fs-1"
                      type={"radio"}
                      ...
                      required
                    ></input>
                    <label className="form-check-label fs-1">Não</label>
                  </div>
                </div>
              </div>
              ...
              <div id="mostrarId" hidden>
                {errorMessage ? (
                  <h1 className="display-1 text-center m-5">
                    Ouve um erro: {errorMessage}
                  </h1>
                ) : (
                  <h1 className="display-1 text-center m-5">
                    Anote seu pedido: {idPedido}
                  </h1>
                )}
              </div>
